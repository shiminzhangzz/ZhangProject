package com.zhang.job.external;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.zhang.job.entity.ExtractRequestBody;
import com.zhang.job.entity.ExtractResponseItem;
import com.zhang.job.entity.Extraction;
...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "cb3c408d8369215530cb854f7f3668217b3748f7";
    ...
    public static void main(String[] args) {
        ...
        List<String> articles = Arrays.asList(
                ...
                "Former Auburn University football coach Tommy Tuberville defeated ex-US Attorn ey General Jeff Sessions in Tuesday nights runoff for the Republican nomination for the U.S. Senate. ",

...
import com.zhang.job.entity.LoginRequestBody;
import com.zhang.job.entity.LoginResponseBody;
...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (connection.verifyLogin(body.userId, body.password)) {
            HttpSession session = request.getSession(); //create session, and save to server memory, send session id to client cookie
